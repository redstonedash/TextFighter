...
void update(Platform p[], Player &player) {
	...
	float x = ((unsigned)state.Gamepad.sThumbLX < 1500) ? 0 : ((float)state.Gamepad.sThumbLX / 32767);
	float y = ((unsigned)state.Gamepad.sThumbLY < 1500) ? 0 : ((float)state.Gamepad.sThumbLY / 32767);
